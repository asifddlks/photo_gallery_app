...
import 'package:photo_gallery_app/models.dart';
import 'package:photo_gallery_app/widget/loading_indicator.dart';
...
class InfoSheet extends StatelessWidget {
        ...
        child: Column(
            ...
            children: image != null
                ? <Widget>[
                    ...
                    // show description
                    _buildDescriptionWidget(image.getDescription()) as Padding,
                    // show location
                    _buildLocationWidget(image.getLocation()!) as Padding,
                    // show exif data
                    _buildExifWidget(image.getExif()!) as Padding,
                    // filter null views
  ...
  Padding? _buildDescriptionWidget(String description) => description != null
      ? Padding(
  ...
  Padding? _buildLocationWidget(Location location) => location != null
      ? Padding(
  ...
  Padding? _buildExifWidget(Exif exif) => exif != null
      ? Padding(
          padding: const EdgeInsets.only(left: 16.0, bottom: 16.0, right: 16.0),
          child: Row(
            children: <Widget>[
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      // display exif info
                      _buildExifInfoItem('ƒ${exif.getAperture()}') as Padding,
                      _buildExifInfoItem('${exif.getExposureTime()}') as Padding,
                      _buildExifInfoItem('${exif.getFocalLength()}mm') as Padding,
                      _buildExifInfoItem('ISO${exif.getIso()}') as Padding,
                    ],
                  ),
                ],
              )
  ...
  Padding? _buildExifInfoItem(String? data) => data != null
      ? Padding(
          padding:
