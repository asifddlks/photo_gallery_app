...
import 'package:photo_gallery_app/unsplash_image_provider.dart';
import 'package:photo_gallery_app/widget/image_tile.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  _loadImages({String? keyword}) async {
    ...
    if (keyword == null) {
      ...
      images = await UnsplashImageProvider.loadImages(page: ++page) as List<UnsplashImage>;
    } else {
        ...
        child: Scaffold(
            ...
            body: OrientationBuilder(
                builder: (context, orientation) => CustomScrollView(
                      ...
                      SliverToBoxAdapter(
                              child: LoadingIndicator(Colors.grey),
                            )
                          ,
                      // filter null views
